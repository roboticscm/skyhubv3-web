...
export class ViewStore {
    ...
    isDisabled = (controlCode, hasError = false) => {
        ...
        if (this.fullControl) {
            ...
            return (
                this.roleControls.filter((item) => item.controlCode === controlCode && item.disableControl === false)
                    .length === 0
            );
        }
    };
    ...
    isRendered = (controlCode, isRendered = true) => {
        ...
        if (this.fullControl) {
            ...
            return (
                this.roleControls.filter((item) => item.controlCode === controlCode && item.renderControl === true)
                    .length > 0
            );
        }
    };
